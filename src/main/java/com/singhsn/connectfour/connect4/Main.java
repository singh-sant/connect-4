...
public class Main extends Application {
    ...
    private MenuBar createMenu(){
        ...
        helpMenu.getItems().addAll(aboutGame, seperator, aboutMe);
    ...
    private void aboutConnect4() {
        ...
        alert.setContentText("Connect Four is a two-player connection game in which the players first choose a color " +
                ...
                "of one's own discs. Connect Four is a solved game. The first player can always win by playing the " +
                "right moves.");
        alert.show();
    }
